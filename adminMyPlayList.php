...
<script type='text/javascript'>
		...
		{		 
		   ...
		   if (col==1)
		   		window.location.assign(getUrl("adminSongofList.php",userid, newRow)+"&songid=");
		   else if(col==4){
		    	...
		    	if (confirm( ps) == true) {
		     		...
		     		//delete 
			    	window.location.assign(getUrl("admindeletePlayList.php",userid,newRow,nextListid));
			    }
			}
		   else 
		    	window.location.assign(getUrl("adminMyPlayList.php",userid,newRow));
...
<?php
	...
	if(isset($_POST['AddButton']))
	{
		...
		header("Location: adminSongofList.php?&listid=-1&songid=");
	}
